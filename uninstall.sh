...
LEGACY_RUNTIME_PATH_FILE="$LEGACY_AUTOSTART_DIR/runtime_app_dir.txt"
...
LEGACY_APP_SUPPORT_UI_SETTINGS="$LEGACY_AUTOSTART_DIR/ui_settings.json"
LEGACY_APP_SUPPORT_UI_SETTINGS_TMP="$LEGACY_AUTOSTART_DIR/ui_settings.json.tmp"
LEGACY_APP_SUPPORT_UI_SETTINGS_BROKEN="$LEGACY_AUTOSTART_DIR/ui_settings.json.broken"
DELETE_DIR=0
WARNINGS=()
...
rm -f "$LEGACY_APP_SUPPORT_UI_SETTINGS" "$LEGACY_APP_SUPPORT_UI_SETTINGS_TMP" "$LEGACY_APP_SUPPORT_UI_SETTINGS_BROKEN"
rm -rf "$AUTOSTART_DIR" "$AUTOSTART_LOG_DIR" "$LEGACY_AUTOSTART_DIR" "$LEGACY_AUTOSTART_LOG_DIR"
